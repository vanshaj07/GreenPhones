...
class HomeScreen extends Component {
    ...
    showAllModels = () => {
        ...
        let modelData = models.map(item => {
            return (
                <div className="card m-2  carousel-cell shadow border-round" style={{width: "8rem"}}>
                    <img className="card-img-top" src={`${IMAGE_URL}${item.image}`} alt="Card image cap"
                         onClick={() => {
    ...
    showSpecificBrands = () => {
        ...
        let brandData;
        if (brands.success) {
            brandData = brands.data.slice(0, 4).map(item => {
                return (
                ...
                <div class="container">
                   ...
                   <button type="submit"><img src="/images/search.png" alt=""/></button> */}
                                    <Autocomplete
                                        ...
                                        renderInput={(params) => (
                                            <TextField  {...params} label="Search your mobile to sell"
                                                        variant="outlined"/>
                                        )}
                                    />
                                    {/* </form> */}
                                ...
                                >
                                    ...
                                    <div className="container  position-relative">
                                        <div className="container position-absolute" style={{bottom: 0, left: 0}}><a
                                            href="/all-brands"
                    ...
                    <div className="container ">
                        <div className="row carousel"
                             data-flickity='{"wrapAround" : true,"autoplay" : true,"pageDots":false}'>
                            {this.showAllBrands()}
                        </div>
                    </div>
